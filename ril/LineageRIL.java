...
public class LineageRIL extends RIL implements CommandsInterface {
...
static int registered = 0;
    ...
    public LineageRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
    }

    public LineageRIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
